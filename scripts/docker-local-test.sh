...
run_compose exec -T hagicode bash -lc 'hagiscript --version >/dev/null && claude --version >/dev/null && openspec --version >/dev/null && skills --version >/dev/null && opencode --version >/dev/null && codex --version >/dev/null'
